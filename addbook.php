...
<head>
    ...
    <script defer src="scripts/addbookvalidation.js"></script>
</head>
        ...
        <section class="addBookSection">
            ...
            <form enctype="multipart/form-data" id="addBookForm" name="addBook"
                ...
                <div class="bookDetailInput">
                    ...
                    <span class="hidden">*Enter a publication date</span>
                    <div>
                        <label for="ISBN">ISBN:</label>
                        <input type="text" name="isbn" id="isbn" placeholder="ISBN" value="<?= $isbn ?>" />
                    </div>
                    <span class="hidden">*ISBN not entered</span>
                    <span id="isbn_length" class="hidden">*ISBN is not valid, must be 13 numbers long</span>
                    <span id="isbn_exists" class="hidden">* The book is already in your account</span>
